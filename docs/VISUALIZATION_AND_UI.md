...
- static city map은 road class, zone/POI, bridge, queue/congestion overlay를 포함하고,
  현실형 mode에서는 block-authoritative land-use polygon을 표시한다. 이는 interactive
  viewer나 품질 검증 판정이 아니다
